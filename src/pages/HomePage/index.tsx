...
return (
    <div className="home">
      ...
      <footer className="home-footer">
        <p className="home-footer-brand">CalendGüi <span>v2.0</span></p>
        <p className="home-footer-info">
          Creado por <strong>Olaf Pedersen</strong> · Learning Resources · Penguin Academy
        </p>
        <a className="home-footer-mail" href="mailto:olaf.pedersen@penguin.academy">
          olaf.pedersen@penguin.academy
        </a>
        <p className="home-footer-copy">© 2026 Penguin Academy. Todos los derechos reservados.</p>
      </footer>
